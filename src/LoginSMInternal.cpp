...
#define LOOKUP_CONNECTION(conn, event) \
...
static char const *const state_names[] = {
    "Initial", "Disconnect", "Playing", "Get_Email", "Confirm_Email",
    "Resend_Confirm_Email", "Get_New_User_Password", "Confirm_Password",
    "Get_Password", "Choose_Ansi", "Show_Motd", "Show_Wmotd", "Show_Credits",
    "Press_Enter", "Show_Account_Menu", "Show_Player_List", "Get_New_Password",
    "Confirm_New_Password", "Get_Confirm_Code", "Show_Creation_Menu",
    "Choose_Name", "Choose_Sex", "Reroll_Abilities", "Choose_Alignment",
    "Choose_Race", "Choose_Stats", "Choose_Class", "Wait_For_Auth",
    "Delete_User", "Show_Login_Menu", "Edit_Extra_Descr",
};
