...
namespace mudbase {
    ...
    public:
        ...
        virtual void property_change(boost::fibers::context * ctx,
            ...
            // Here we know that ctx was in our ready queue, but we've
            // unlinked it. We happen to have a method that will (re-)add a
            // context* to the right place in the ready queue.
            awakened(ctx, props);
        }
