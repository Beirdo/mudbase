...
namespace mudbase {
    ...
    TCPServer::TCPServer(const std::string &address, const std::string &port)
        ...
        // exit.  It is safe to register for the same signal multiple times in
        // a program, provided all registration for the specified signal is
        // made through Asio.
        signals_.add(SIGINT);
    ...
    void TCPServer::handle_accept(TCPConnection_ptr connection,
